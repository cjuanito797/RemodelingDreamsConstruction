...
class Employee(models.Model):
    ...
    employer_1_still_employed = models.CharField(max_length = 25, choices=BOOL_CHOICES, blank=False)
    employer_1_may_we_contact = models.CharField(max_length = 30, choices=BOOL_CHOICES, blank=False)
    ...
    employer_2_still_employed = models.CharField(max_length = 30,choices=BOOL_CHOICES, blank=True)
    employer_2_may_we_contact = models.CharField(max_length = 30,choices=BOOL_CHOICES, blank=True)
    ...
    employer_3_still_employed = models.CharField(max_length = 30,choices=BOOL_CHOICES, blank=True)
    employer_3_may_we_contact = models.CharField(max_length = 30,choices=BOOL_CHOICES, blank=True)
